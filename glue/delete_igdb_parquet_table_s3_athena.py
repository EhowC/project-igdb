...
# Update the database, tables, and S3 buckets
BUCKET_TO_DEL = '< S3 bucket to clear contents>'
DATABASE_TO_DEL = '< database >'
TABLE_TO_DEL = '< parquet table to delete >'
QUERY_OUTPUT_BUCKET = '< Athena S3 results bucket >'
