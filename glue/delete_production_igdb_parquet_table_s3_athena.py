...
BUCKET_TO_DEL = ' <s3 bucket for production parquet table'
DATABASE_TO_DEL = '<Athena database>'
TABLE_TO_DEL = '<production table to delete>'
QUERY_OUTPUT_BUCKET = '<S3 bucket for Athena query results>'
